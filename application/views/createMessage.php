        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-sharp">
                    ...
                    <span class="caption-subject bold uppercase"> Create message</span>

                </div>
                <div class="actions">
                    <a href="<?=base_url()?>inbox" align="right" class="btn btn-circle btn-default" id="btnAddNewUser"><span class="fa fa-plus"></span> View Inbox </a>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <form method="post"> 
                       <?php
                        ...
                        <form class = "form-horizontal" action="<?php echo base_url() ?>inbox" method="post">                        
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea rows="7" cols="50" class="form-control" name="body" id="body" ></textarea>
                              ...
                              <!--   <div class="form-group">
                                ...
                                <input type="hidden" name="message_type_id" id="message_type_id" value="1">
                           ...
                           <!--  <div class="actions">  
                            <label class="control-label">Select Permission</label> 
                                ...
                                <option value="<?php echo $all_permission['permission_code'];?>"><?php echo 
                                 $all_permission['permission_description'];?></option><?php } ?>
                                </select>
                            </div> -->
                                       
                                <div class="form-group">
                                        <button type="submit" onclick="clearFields()" value="Clear" class = "btn btn-info center-block ">Send</button>                                      
