...
class canvassModel extends CI_Model {
...
function retrieve_all_items()
    ...
    {
        $this->db->trans_start();
        $this->db->insert('canvass_supplier', $data);
    ...
    function insert_canvass_items($data)
    {
        $this->db->trans_start();
        $this->db->insert('canvass_item', $data);
        $lastCanvassItem = $this->db->insert_id();
        $this->db->trans_complete();
        return $lastCanvassItem;
