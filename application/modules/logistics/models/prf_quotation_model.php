...
class prf_quotation_model extends CI_Model
{
    ...
    function quote_details($id)
    {
        ...
        $this->db->join('item i', 'c.item_id = i.item_id', 'inner');  
        ...
        // $this->db->join('person h', 'f.person_id = h.person_id', 'left');
         ...
         // $this->db->where('c.quotation_detail_id', $id);
...
function retrieve_all_prf()
    ...
    function getAllQuotation()
    {
         ...
         $this->db->join('quotation e', 'a.prf_id = e.prf_id', 'inner');         
         $query = $this->db->get();
         return $query->result_array();
    }
       ...
       function to_head($id)
    {
        ...
        //  $this->db->join('item c', 'a.item_id = c.item_id', 'inner');
        //  $query = $this->db->get();
        // $this->db->where('quotation_detail_id', $id);
        //  return $query->result_array();
