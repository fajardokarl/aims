...
<span class="bold uppercase">Select supplier to create PO </span>
</div>
<div class="actions"> 
...
<div class="form-group">
    ...
    $supplier_selected['organization_name'];?></option><?php } ?>
    </select>    
...
<button type="button" id="po_request" class="btn btn-primary ">Create</button>
