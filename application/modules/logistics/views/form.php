...
<form class="col-md-12" method="post" name = "budgeted" id="budgeted">
<div class="row">
<div class="col-md-18">
...
<div class="caption">
<i class="fa fa-gift"></i>Budgeted Item</div>
<div class="tools">
...
<div class="cpl-md-20">
    ...
    <td>
    <select class="form-control select2 select2-hidden-accessible" id="budget" name="budget" required>
...
<td>
    <select class="col-md-8 form-control select2 select2-hidden-accessible" id="custodian" name ="custodian" >
    <option value="0" class ="disabled selected">Select</option>
...
<td>
    <select class="form-control select2 select2-hidden-accessible" id="asset_item" name="asset_item" required>
    <option selected disabled></option>
    </select>
</td>  
...
<button type="button" onclick="clearFields()" value="Clear" class="btn btn-danger ">Cancel</button>
</div>
</form>
