...
<span class="bold uppercase">Replacement/Capitalizable Repairs</span>
</div>
<div class="actions"> 
<!-- <a href="javascript:;"><i class="fa fa-file-pdf-o btn red"> PDF</i> </a> -->
<button style="align:right;" type="button" class="btn btn-default btn-sm" id="pdf_capex_form"><i class="fa fa-plus"> </i>Get PDF</button>
</div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <p class="form-control-static">
            ...
            <input type="hidden" id="capex_id" value="<?php echo $capex->capex_id; ?>">
        </p>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <p class="form-control-static">
            <?php echo $capex->classification_name; ?>
        </p>
    </div> 
</div>         
    </div>
