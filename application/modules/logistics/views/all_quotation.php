...
<form class="form-horizontal">
    ...
    <label class="col-md-7 control-label"><span class="caption-subject font-green bold uppercase"> Select to create quotation</span></label>
</div>
<div class="row">
<div class="col-md-6">
    <!-- <div class="form-group"> -->
...
<div class="col-md-6">
    <div class="form-group">
        <label class="col-md-6 control-label"><span class="caption-subject font-grey-mint bold uppercase"> Department:</span></label>
        <div class="col-md-6">
            <p class="form-control-static">
...
<table class="table table-hover" id="list_of_quote">
    ...
    <?php foreach($details as $details){ ?>
        <tr>         
            ...
            <td><?php echo $details['organization_name']; ?></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
