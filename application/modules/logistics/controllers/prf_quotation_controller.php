...
class prf_quotation_controller extends CI_Controller{
	  ...
	  function __construct()
    {
       ...
       //$this->load->model('inbox/inbox_main');
        ...
        $this->data['customjs'] = 'logistics/quotation_js';
...
public function pdf_quotation()
     {
        ...
        // if ($head_val->client_type_id == 1) {
        // $id = strtoupper($supplier->person_add);
        // $supplierTIN = $head_val->tin;
        // // ." ".$supplier->line_2." ".$supplier->line_3;
          
        // }elseif ($head_val->client_type_id == 2) {
        // $id = strtoupper($head_val->org_add);
        // $supplierTIN = $head_val->tin;
        // // ." ".$supplier->line_2." ".$supplier->line_3;
        ...
        $pdf->writeHTMLCell(30, '', 100, '', '<b>Item Remark</b>', 0, 0, 0, true, 'L', true);
        $pdf->writeHTMLCell(30, '', 150, '', '<b>Price Offer</b>', 0, 0, 0, true, 'L', true);
        ...
        foreach ($detail_val as $key => $value) {
            ...
            $pdf->writeHTMLCell(40, '', 100, '', $value['quote_remark'], 0, 0, 0, true, 'L', true);         
