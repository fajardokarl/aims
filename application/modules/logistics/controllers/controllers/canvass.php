 ...
 public function pdf_report()
     {
        ...
        // $pdf->writeHTMLCell(40, '', '', '', '<b>PRF ID: </b>', 0, 0, 0, true, 'L', true);
        // $pdf->writeHTMLCell(30, '', '', '', $prfid, 0, 0, 0, true, 'L', true);
        ...
        $pdf->writeHTMLCell(48, 7.2, '' , '', '<b>Item Description</b>', 1, 0, 0, true, 'L', true);
        $pdf->writeHTMLCell(25, 7.2, '' , '', '<b>Unit Price</b>', 1, 0, 0, true, 'L', true);
        $pdf->writeHTMLCell(25, 7.2, '' , '', '<b>Price Offer</b>', 1, 0, 0, true, 'L', true);
        ...
        foreach ($report_details as $key => $value) {
            ...
            $pdf->writeHTMLCell(48, 5.8, '', '', $value['description'], 1, 0, 0, true, 'L', true);
            $pdf->writeHTMLCell(25, 5.8, '', '', number_format($value['price_offer']), 1, 0, 0, true, 'L', true);
            $pdf->writeHTMLCell(25, 5.8, '', '', number_format($value['price_offer']), 1, 0, 0, true, 'L', true);
...
$pdf->writeHTMLCell(130, 5.8, '', '',$notes.$br.$one.$br.$two.$br.$three.$br.$four.$br.$five.$br.$six.$br.$seven, 1, 0, 0, true, 'L', true);
        // $pdf->Ln(7);
$pdf->writeHTMLCell(50, 10, '','','Total: '.$date, 1,0,0, true, 'C', true);
$pdf->Ln();   
