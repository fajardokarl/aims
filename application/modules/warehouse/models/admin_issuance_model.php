...
class admin_issuance_model extends CI_Model {
public function __construct()
    ...
    function retrieve_po_admin_status($po_id) {
        $this->db->trans_start();
    ...
    function getMaterialsRequisition(){
        ...
        $this->db->order_by('is.issuance_id');
        $query = $this->db->get();
        return $query->result_array();
        $this->db->trans_complete();
    }
    ...
    function update_isd($info, $issuance_detail_id) {
        $this->db->where('issuance_detail_id', $issuance_detail_id);
