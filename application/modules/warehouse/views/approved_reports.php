                    ...
                    <table class="table table-hover" id="po_table" style="color: #525e64!important;">
                        ...
                        <?php $previous_po_id = 0;
                          ...
                          foreach($PO_details as $PO_details){
                            ...
                            if($current_po_id != $previous_po_id && strtoupper($PO_details['po_admin_status']) == "COMPLETE") { ?>
                            <tr>
                        ...
                        <thead>
                                    ...
                                    <tbody>
                                        ...
                                        foreach($MR_details as $detail) {
                                            ...
                                            if($current_issuance_id != $previous_issuance_id && $detail['issuance_status'] == "CONFIRMED") { 
                                            ?>
                                            <tr>
