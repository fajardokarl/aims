...
class assign_employee_controller extends CI_Controller 
{
    public function __construct(){
        ...
        $this->load->model('assign_employee_model',"aem");
        $this->load->library('session');
        // $this->load->view('/employee/employee/department_id/','')
        $this->load->helper(array('form', 'url'));  
        $this->data['customjs'] = 'department_js';
    }

    public function index(){
        $this->data['content'] = 'assign_employee_view';
        $this->data['page_title'] = 'Assign Employee';
    ...
    public function pass_department_id()
    {
    ...
    public function get_all_employee_in_department()
    {
        ...
        echo json_encode($this->aem->employee_in_department($dept_id));
    }

    public function get_department_name()
    {
        $dept_id = $_POST['dept_id'];
        echo json_encode($this->aem->department_name($dept_id));
    }

    public function get_department_head()
    {
        $dept_id = $_POST['dept_id'];
        echo json_encode($this->aem->department_head($dept_id));
    }
