...
class Department_manager_model extends CI_Model{
	function get_Manager(){
		$this->db->select('department_manager.department_id,person.lastname,person.firstname,department_manager.department_employee_id,department_manager.employee_id');
        $this->db->from('department_manager');
        $this->db->join('employee', 'department_manager.employee_id = employee.employee_id', 'left');
