	...
	<table id="all_my_TO" class="table table-hover">
	   <thead>
        ...
        <?php foreach($retrieve as $retrieve){ ?>
            ...
            <td><button type="button" class="btn blue-dark btn-lot-edit btn-xs" data-toggle="modal" data-target="#view-TO" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Request cash vale</button></td>                    
            </tr>
			<?php } ?>
		</tbody>
	</table>  
