    ...
    <div class="portlet light " id="monthlydues">
        <div class="portlet-title">
            <div class="caption font-green-sharp">
                ...
                <span class="caption-subject bold uppercase"> Monthly Collection</span>
            </div>
            <div class="actions">
        ...
        <div class="portlet-body"> 
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="control-label" style="text-align: center;" id="title2">Monthly Collection</h4>
                    <h4 class="control-label" style="text-align: center;" id="year_text"><?php echo date("M Y");?></h4>
                </div>
                <div class="col-md-4">
                </div>
            </div>
...
<a href="<?php echo base_url(); ?>reports/MonthlyCollection.xls" style="display: none;"><input type="button" id="exceltrigger" value="Test" class="btn btn-success"></a>