            ...
            <div class="portlet grey-cascade box " id="bankslists">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption"> Payment Details</span>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="portlet grey-cascade box " id="bankslists">
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button style="float: right;" type="button" class="btn btn-circle green" id="add"><i class="fa fa-plus"></i> Add Payment</button>
                        </div>
                    </div>       
                </div> 
            </div>
    ...
    <div class="col-md-12">
        <div class="portlet grey-cascade box " id="bankslists">
            ...
            <div class="portlet-body">          
                <div class="row">
                    <div class="col-md-12">
                        <table class="tblnvrpayments table table-hover" id="tblnvrpayments">
                            <thead>
                                <tr>
                                    <th>Account Code</th>
...
<button type="button" id="wiw">Close</button>
