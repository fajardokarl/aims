                        ...
                        <table class="table table-hover table-bordered table-striped" id="tbl-payments">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $sundry = 0;
                                    $run_bal = 0;
                                    $tcp = $contract->total_contract_price;
                                    $percent = 0;
                                ?>
                                <?php foreach ($payment as $payment) { ?>
                                    <tr>
                                        <?php 
                                            ...
                                            $sundry += $payment['sundry'];
                                            $percent = ($amount / $tcp) * 100;

                                         ?>
                                        <td style="display: none;"><?php echo $payment['payment_id'];?></td>
                                        <td><?php echo 'OR#' . $payment['pay_reference'] . '' . $payment['payment_id']; ?></td>
                                        ...
                                        <td align='right'><?php echo number_format($payment['interest'], 2);?></td> 
                                        <td align='right'><?php echo number_format($payment['surcharge'], 2);?></td>
                                        <td align='right'><?php echo number_format($payment['sundry'], 2);?></td>
                                        <td align='right'><?php echo number_format(($tcp - $amount), 2); ?></td>
                                        <td align='right'><?php echo number_format($percent, 2) . "%"; ?></td>
                                        <!-- <td><a class="btn green btn-xs edit_misc_details"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> edit</a></td> -->
                                    </tr>
                                <?php } ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td align='right' style="font-weight: bold;"><?php echo "₱ " . number_format($amount, 2); ?></td>
                                    <td align='right' style="font-weight: bold;"><?php echo "₱ " . $surcharge; ?></td>
                                    <td align='right' style="font-weight: bold;"><?php echo "₱ " . $sundry; ?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            </tbody>
