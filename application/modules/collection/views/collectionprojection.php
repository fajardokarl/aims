    ...
    <div class="portlet light " id="monthlydues">
        <div class="portlet-title">
            <div class="caption font-green-sharp">
                ...
                <span class="caption-subject bold uppercase"> Collection Projection</span>
            </div>
            <div class="actions">
        ...
        <div class="portlet-body"> 
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="control-label" style="text-align: center;" id="title2">Collection Projection</h4>
            ...
            <div style="width: 100%; overflow-x: auto; white-space: nowrap;">
                <table class="tblcollectionprojection table table-hover" id="tblcollectionprojection">
                    <thead>
                        <tr>
                            <th>Lot ID</th>
...
<a href="<?php echo base_url(); ?>reports/CollectionProjection.xls" style="display: none;"><input type="button" id="excel1trigger" value="Test" class="btn btn-success"></a>
