									...
									<tbody>
										<?php foreach ($lots as $lots) {?>
											<tr>
												...
												<td style="display: none;"><button type="button" class="btn blue-dark btn-lot-edit btn-xs" data-toggle="modal" data-target="#view-lots" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</button></td>
											</tr>
										<?php } ?>
										</>
									</tbody>
