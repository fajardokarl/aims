...
class Maps extends CI_Controller {
	...
	public function index(){
		...
		$this->data['content'] = 'maps/vmap_terraces';
		$this->data['customjs'] = 'maps/map_terracesjs';
    ...
    public function ventura2(){
        ...
        $this->data['content'] = 'maps/vmap_ventura2';
        $this->data['customjs'] = 'maps/map_ventura2js';
        $this->load->view('default/index', $this->data);
    }

    public function ignatius(){
        $this->data['page_title'] = 'Maps | Ignatius Enclave';
        $this->data['content'] = 'maps/vmap_ignatius';
        $this->data['customjs'] = 'maps/map_ignatiusjs';
        $this->load->view('default/index', $this->data);
    }

    public function valencia(){
        $this->data['page_title'] = 'Maps | Valencia Estate';
        $this->data['content'] = 'maps/vmap_valencia';
        $this->data['customjs'] = 'maps/map_valenciajs';
        $this->load->view('default/index', $this->data);
    }

    public function teakwood(){
        $this->data['page_title'] = 'Maps | teakwood Hills';
        $this->data['content'] = 'maps/vmap_teakwood';
        $this->data['customjs'] = 'maps/map_teakwoodjs';
