<div class="page-content"> 
    <div class="row">
        ...
        <div class="col-md-12" align="center">
	        	<img src="<?=base_url()?>\public\images\THE-TERRACES-PLAN-Model.jpg" style="width: 792px; height: 1224px; left: 0;z-index: 100;">
	        	<div id="vmap" style="width: 792px; height: 1224px; z-index: 1000; opacity: .8; margin-top: -1245px;" ></div>
        </div>
    </div>
</div>
