        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image: url(<?=base_url()?>public/images/projects/17.jpg);">
                        <img class="login-logo" src="<?=base_url()?>public/images/logo.png" /> 
                    </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>Metronic Admin Login</h1>
                        <p>asdasdasdasd uismod aliquam erat volutpat. Lorem ipsum dolor sit amet, coectetuer adipiscing. </p>
