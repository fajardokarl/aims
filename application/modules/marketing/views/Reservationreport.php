<div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <center>
                                ...
                                <h3 class="caption-subject bold uppercase"> Reservation Report</h3>
                            </center>
                        </div>
                        <div class="col-md-4">
                        </div>
        ...
        <a href="<?php echo base_url(); ?>reports/reservations.xls" style="display: none;"><input type="button" id="xls_trigger" value="Test" class="btn btn-success"></a>
</div>
