        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-sharp">
                    ...
                    <span class="caption-subject bold uppercase"> User Masterlist</span>

                </div>
                <div class="actions">
                    <a href="<?=base_url()?>login/users/registration" align="right" class="btn btn-circle btn-default" id="btnAddNewUser"><span class="fa fa-plus"></span> Add User </a>
                </div>  
                    ...
                    <table class="table table-hover" id="tbluser">
                        ...
                        <?php foreach($users as $user){ ?>
                            <tr>
                                ...
                                <td><?php echo $user['lastname'] . ', ' . $user['firstname'] . ' ' . $user['middlename'] . ' ' . $user['suffix'];?></td>
                                <td><?php echo $user['username']; ?></td>
                                <td><?php echo ($user['last_logged'] === NULL) ? "Never" : $user['last_logged']; ?></td>                               
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
