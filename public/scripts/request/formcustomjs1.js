...
//--- end here
  ...
  $('#project_id').change(function(){      
      ...
      var lot_id = "";
        $.ajax({
          type: "POST",
          url:  baseurl + "logistics/request/retrieve_lots",
          dataType: "json",
          data: {'project_id': project_id},
          success: function(data){
              $.each(data, function(i, value){                 
                      lot_id += "<option value='" + data[i].lot_id + "'>" + data[i].lot_description + "</option>"                       
...
//-----------------------Replacement mapping------------------------------
      ...
      var data = {
        ...
        //= to view ID.......value to be inserted//
         ...
         // 'item':$('#capex_description option:selected').val(),
         // 'purpose':$('#purpose').val(),
         // 'budgeted':$('#classification_name option:selected').val(),
...
prf_item_table.row.add( [ 
        ...
        "<input type='hidden' name='budgeted[]' value='" + $("#budgeted").val() + "'>" + $("#budgeted").val(),        
