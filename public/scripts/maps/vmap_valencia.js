                        ...
                        if (code != "road" && code != '') {
                            $.ajax({
                                ...
                                success : function(data){
                                    var stat, is_booked, is_invoiced, house_lot, house_pic, with_house;
                                    ...
                                    if (data[0].picture_url != 0 && data[0].picture_url != '' && data[0].picture_url != null) {
                                        house_pic = baseurl + 'public/images/houses/' + data[0].picture_url;
                                        $('#pic_cont').show(); 
                                        $('#house_pic').attr('src', house_pic);
                                    }else{
                                    ...
                                    $('#lot_desc').html(stat + " " + data[0].project_name + "- " + data[0].phase_name + "- Block " + data[0].block_no + "- Lot" + data[0].lot_no + " " + with_house);
                                    $('#map_lotarea').html(data[0].lot_area  + " Sq M");
                                    $('#map_floorarea').html(data[0].floor_area + " Sq M");
                    ...
                    success : function(data){
                        ...
                        $.each(data, function (index, value){
                            ...
                            if (data[index].availability == 1) {
                                if (data[index].with_house == 1) {
                                    change_color(lot_id, '#ff9600');
                                }else{                                    
