var TableDatatablesEditable = function() {
  var all_contracts = $("#all_contracts").DataTable({searching: false, paging: false, "lengthMenu": [[5, 10, 25, 50, -1], [5, 10, 25, 50, "All"]], "columnDefs": [
                    {
                        "targets": [ 0 ],
                        "visible": false,
                        "searchable": false
  ...
  // var table = $('#address_add').DataTable({searching: false, paging: false});
        ...
        $('#all_contracts').on('dblclick', 'tr', function () {
            ...
            window.open(baseurl+"marketing/amortizationdetails?contractid="+contract_id);
         });
