$(document).ready(function(){
    ...
    $('#print1').click(function () {
        ...
        var TableData1 = [];
        var rows = $("#tblsalesprojection").dataTable().fnGetNodes();
        ...
        $.ajax({
            type: "POST",
            url:  baseurl + "collection/print_sales_projection",
            data: {'data':data,'project':projectname,'year':year},
            success: function(data){
                var url = baseurl + "reports/SalesProjection.pdf";
    ...
    $('#excel1').click(function () {
        ...
        $.ajax({
            type: "POST",
            url:  baseurl + "collection/get_sales_projection_report",
            data: {'data':data,'project':projectname,'year':year},
            success: function(data){
    ...
    $('#generate').click(function () {
        ...
        $.ajax({
            ...
            for(var i=0; i < data.length; i++) {
                ...
                var bool = checkPercentPaid(contractID,tcp);
...
function checkPercentPaid(contractID,tcp) {
